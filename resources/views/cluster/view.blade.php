...
<div class="container ">
    <div class="row justify-content-center d-flex flex-column">
        <div class="cluster-heading bg-dark text-white py-2">
            ...
            <a href="#" class="btn btn-raised btn-primary float-right m-1">View Members</a>
            <a href="#" class="btn btn-raised btn-success float-right m-1">Share</a>
        ...
        <div class="bg-white border-2 py-3 my-3 border-dark border shadow-sm">
                @if ($errors->any())
            ...
            <div class="row mx-1">
                ...
                <button type="submit" class="btn btn-success float-right col-1">{{'Send'}}</button>
            </div>
            </form>
        </div>
    </div>
